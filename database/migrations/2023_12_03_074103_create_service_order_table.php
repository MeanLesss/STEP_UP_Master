...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('service_order', function (Blueprint $table) {
            ...
            $table->json('completed_attachments')->default(DB::raw('(JSON_OBJECT())'))->nullable()->comment('[{0 :"Path1"},{ 1 :"path2"}]');
            $table->date('completed_at')->nullable();
            $table->json('order_attachments')->default(DB::raw('(JSON_OBJECT())'))->nullable()->comment('[{0 :"Path1"},{ 1 :"path2"}]');
